...
class MainAdapter(val activity: Activity, @LayoutRes id: Int, dataList: ArrayList<GettyImageInfo>)
    : V7Adapter<GettyImageInfo, MainViewHolder>(activity, id, dataList) {
